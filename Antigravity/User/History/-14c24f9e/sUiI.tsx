  ...
  return (
    <>
      ...
      <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
        ...
        <Link 
          href="/" 
          className="absolute top-8 left-8 text-foreground/80 hover:text-primary transition-colors duration-200 flex items-center gap-2 group cursor-pointer"
        >
          <div className="p-4 rounded-full bg-white shadow-[4px_4px_10px_rgba(0,0,0,0.05),-4px_-4px_10px_rgba(255,255,255,0.8)] group-hover:scale-110 transition-transform">
        ...
        <div className="relative z-10 w-full max-w-md">
          <div className="clay-card p-12 relative overflow-hidden !rounded-[3rem]">
            {/* Header */}
