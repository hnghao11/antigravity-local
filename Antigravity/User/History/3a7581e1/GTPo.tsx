  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <GlassCard className="flex items-center justify-between !rounded-[2rem] hover:scale-[1.02] transition-transform p-6 bg-white dark:bg-card">
            <div>
            ...
            <div className="flex h-16 w-16 items-center justify-center rounded-full bg-blue-100 text-blue-600 shadow-inner group-hover:scale-110 transition-transform">
                <LayoutGrid className="w-8 h-8" />
            </div>
        </GlassCard>
         <GlassCard className="flex items-center justify-between !rounded-[2rem] hover:scale-[1.02] transition-transform p-6 bg-white dark:bg-card">
            <div>
                ...
                <p className="text-4xl font-black text-foreground">{completedCount}</p>
            </div>
            <div className="flex h-16 w-16 items-center justify-center rounded-full bg-emerald-100 text-emerald-600 shadow-inner group-hover:scale-110 transition-transform">
                <CheckCircle2 className="w-8 h-8" />
            </div>
        </GlassCard>
         <GlassCard className="flex items-center justify-between !rounded-[2rem] hover:scale-[1.02] transition-transform p-6 bg-white dark:bg-card">
             <div>
                <p className="text-sm font-bold text-muted-foreground uppercase tracking-wider mb-1">In Progress</p>
                <p className="text-4xl font-black text-foreground">{activeCount}</p>
            </div>
            <div className="flex h-16 w-16 items-center justify-center rounded-full bg-orange-100 text-orange-600 shadow-inner group-hover:scale-110 transition-transform">
