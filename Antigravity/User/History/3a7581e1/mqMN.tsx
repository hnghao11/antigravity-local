  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <GlassCard className="flex items-center gap-6 !rounded-[2rem] hover:scale-[1.02] transition-transform">
            <div className="p-4 bg-blue-100 rounded-full text-blue-600 shadow-sm">
                <LayoutGrid className="w-8 h-8" />
            </div>
            <div>
                <p className="text-sm font-bold text-muted-foreground uppercase tracking-wider">Total Projects</p>
         ...
         <GlassCard className="flex items-center gap-6 !rounded-[2rem] hover:scale-[1.02] transition-transform">
            <div className="p-4 bg-orange-100 rounded-full text-orange-600 shadow-sm">
      ...
      {/* Controls */}
      <div className="clay-card !rounded-[2rem] p-3 flex items-center gap-4 bg-white dark:bg-card">
        <div className="relative flex-1">
            ...
            <input 
                ...
                className="w-full bg-transparent border-none focus:ring-0 pl-12 text-base font-medium placeholder:text-muted-foreground"
            />
        </div>
        <div className="h-8 w-px bg-border group-hover:bg-primary/20" />
        <div className="flex items-center gap-2 pr-2">
            <Button 
                variant={view === 'grid' ? 'secondary' : 'ghost'} 
                size="icon" 
                onClick={() => setView('grid')}
                className={cn("cursor-pointer rounded-full h-10 w-10", view === 'grid' && "bg-primary/10 text-primary hover:bg-primary/20")}
            >
             ...
             <Button 
                ...
                className={cn("cursor-pointer rounded-full h-10 w-10", view === 'list' && "bg-primary/10 text-primary hover:bg-primary/20")}
            >
